...
I1 = cv.cvtColor(cv.imread(r'C:\Users\rajna\Desktop\3Drec\data\im1.png'), cv.COLOR_BGR2GRAY).astype(np.float32)
I2 = cv.cvtColor(cv.imread(r'C:\Users\rajna\Desktop\3Drec\data\im2.png'), cv.COLOR_BGR2GRAY).astype(np.float32)

rectify = np.load(r'C:\Users\rajna\Desktop\3Drec\data\rectify.npz')
